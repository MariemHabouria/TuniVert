...
<head>
    ...
    <style>
        ...
        #spinner {
            display: none !important; /* Hide spinner after page load */
        }
        .navbar {
        ...
        .carousel-header {
            height: auto;
            min-height: 100vh; /* Optional: full viewport height for carousel */
        }
    </style>
</head>
...
<body>
    ...
    <!-- Inline JavaScript to Ensure Spinner Hides -->
    <script>
