      ...
      <nav class="navbar navbar-light bg-light navbar-expand-xl">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav ms-auto">
            ...
            {{-- Formation (catalogue) --}}
            <li class="nav-item"><a href="{{ route('formations.index') }}" class="nav-link">Formation</a></li>

            {{-- Si association connectée : lien de création --}}
            @auth
              @if(auth()->user()->role === 'association')
                <li class="nav-item"><a href="{{ route('formations.create') }}" class="nav-link">Créer une formation</a></li>
              @endif
            @endauth
