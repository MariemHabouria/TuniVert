        ...
        <nav class="navbar navbar-light bg-light navbar-expand-xl">
            ...
            <div class="collapse navbar-collapse bg-light" id="navbarCollapse">
                <div class="navbar-nav ms-auto">
                    ...
                    <a href="{{ route('events') }}" class="nav-item nav-link {{ request()->routeIs('events') ? 'active' : '' }}">Événements</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0 bg-secondary rounded-0">
                            @if(Auth::user()->role === 'association')
                                ...
                                <a href="{{ route('scores.classement', ['challenge' => 'current']) }}" class="dropdown-item {{ request()->routeIs('challenges.profil') ? 'active' : '' }}">
                                    <i class="fas fa-chart-bar me-2"></i>Statistiques
                                </a>
                            @else
                                <!-- Menu User normal -->
                                <a href="{{ route('challenges.index') }}" class="dropdown-item {{ request()->routeIs('challenges.index') ? 'active' : '' }}">
                                    <i class="fas fa-trophy me-2"></i>Voir les Challenges
                                </a>
                                <a href="{{ route('challenges.profil') }}" class="dropdown-item {{ request()->routeIs('challenges.profil') ? 'active' : '' }}">
                ...
                <div class="d-flex align-items-center flex-nowrap pt-xl-0" style="margin-left: 15px;">
                    @guest
                    <div class="nav-item d-flex align-items-center gap-2 ms-lg-2">
